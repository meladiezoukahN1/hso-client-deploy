    ...
    <div className="relative w-full h-screen overflow-auto">
      ...
      >
        ...
        <div className="text-white text-center">
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl mb-4 font-bold border-y-2 border-[#FFC625] p-4">
            فريق التحول الرقمي - جامعة طرابلس
          </h1>
          <p className="mb-4 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-justify">
          ...
          <ul className="list-disc text-sm sm:text-base md:text-lg lg:text-xl space-y-2 marker:text-yellow-500 pr-6 md:pr-10 text-right">
            <li>
        ...
        <Link href="/about_team/our_team">
          <button
            className="px-6 py-2 mt-8 bg-[#E5B11F] text-white font-bold rounded-lg hover:bg-yellow-500 focus:outline-none sm:px-8 mb-5 md:mb-0 sm:py-3 md:px-10 md:py-4"
